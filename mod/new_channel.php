...
function new_channel_content(&$a) {
	...
	$o = replace_macros(get_markup_template('new_channel.tpl'), array(
		...
		'$role' => array('permissions_role' , t('Channel Type'), ($privacy_role) ? $privacy_role : 'social_private', '<a href="help/roles" target="_blank">'.t('Read more about roles').'</a>',get_roles()),
		'$nickname'     => $nickname,
		'$submit'       => t('Create')
	));
